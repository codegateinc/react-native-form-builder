...
import { Styles, ModalAnimation } from 'lib/types'
import { colors } from 'lib/common'
import { R } from 'lib/utils'
import { Label } from './Label'
import { SelectPickerProps, OptionValue, PickerOption } from '../types'
...
export class SelectPicker extends React.Component<SelectPickerProps, SelectPickerState> {
    static defaultProps: Partial<SelectPickerProps> = {
        pickerTitle: '',
        pickerOptions: [],
    ...
    constructor(props: SelectPickerProps) {
        ...
        const [firstOption] = this.props.pickerOptions as Array<PickerOption>
    ...
    toggleModalVisibility(isModalVisible: boolean) {
        this.setState({
            isModalVisible,
    ...
    getLabelForSelectedOption(selectedOption?: OptionValue) {
    ...
    renderPickerOption(option: PickerOption) {
        return (
            <Picker.Item
                key={option.value}
                value={option.value}
    ...
    renderPicker() {
        return this.props.pickerOptions ? (
    ...
    renderLabel() {
        return this.props.withLabel ? (
            <Label text={this.props.withLabel}/>
        ) : null
    }
        ...
        return (
            ...
            >
                ...
                <TouchableOpacity
                    ...
                    onPress={!this.props.isDisabled ? () => this.toggleModalVisibility(true) : undefined}
                >
